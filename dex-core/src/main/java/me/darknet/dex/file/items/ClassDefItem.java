...
public record ClassDefItem(@NotNull TypeItem type, int access, @Nullable TypeItem superType, @NotNull TypeListItem interfaces,
    ...
    public static ItemCodec<ClassDefItem> CODEC = new ItemCodec<>() {
        ...
        @Override
        public ClassDefItem read0(@NotNull Input input, @NotNull DexMapAccess context) throws IOException {
        ...
        @Override
        public void write0(ClassDefItem value, @NotNull Output output, @NotNull WriteContext context) throws IOException {
